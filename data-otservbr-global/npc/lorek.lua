...
addTravelKeyword("darama", "to darama", 7, Position(32987, 32729, 7))
addTravelKeyword("center", "the centre of Port Hope", 0, Position(32628, 32771, 7))
addTravelKeyword("chor", "to chor", 7, Position(32968, 32799, 7))
addTravelKeyword("banuta", "to banuta", 7, Position(32826, 32631, 7))
addTravelKeyword("mountain", "to the mountain", 7, Position(32987, 32729, 7))
addTravelKeyword("mountain pass", "to the mountain pass", 7, Position(32987, 32729, 7))
-- Basic
